...
const jwt = require('jsonwebtoken'); // generated signed token
...
exports.signin = (req, res) => {
    ...
    User.findOne({ email }, (err, user) => {
        ...
        // found user; validate email and password
        ...
        // return response with user + token to client(front-end)
